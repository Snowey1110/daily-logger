...
const EN = {
  ...
  sketchShiftStraightLine: 'Hold Shift for straight lines',
  ...
  rightTabStt: 'Speech',
  compositeEditorTitle: 'Page Editor',
  layerText: 'Text',
  layerSketch: 'Sketch',
  layerImages: 'Images',
  layerMoveUp: 'Move Up',
  ...
  imagePaste: 'Paste (Ctrl+V)',
  imageDelete: 'Delete Image',
  compositeEditorSave: 'Save',
} as const;
...
const ZH: { [K in keyof typeof EN]: string } = {
  ...
  sketchpad: '涂鸦板',
  clearCanvas: '清空画布',
  sketchShiftStraightLine: '按住 Shift 画直线',
  saveSketch: '保存涂鸦',
  settingsTitle: '设置',
  ...
  layerMoveDown: '下移',
  imageUpload: '上传图片',
  imagePaste: '粘贴 (Ctrl+V)',
  imageDelete: '删除图片',
  compositeEditorSave: '保存',
};
