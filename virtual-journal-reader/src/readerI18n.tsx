...
const EN = {
  ...
  settingsRightPage: 'Right Page Content',
  settingsNone: 'None (journal only)',
  settingsAiRight: 'AI Report',
  settingsSttRight: 'Speech-to-Text',
  sketchPlacerTitle: 'Sketch Manager',
  sketchInsertHere: 'Click to insert sketch here',
...
const ZH: { [K in keyof typeof EN]: string } = {
  ...
  saveSketch: '保存涂鸦',
  settingsTitle: '设置',
  settingsRightPage: '右侧页面内容',
  settingsNone: '无（仅日记）',
  settingsAiRight: 'AI 报告',
  settingsSttRight: '语音转写',
  sketchPlacerTitle: '涂鸦管理',
  sketchInsertHere: '点击此处插入涂鸦',
